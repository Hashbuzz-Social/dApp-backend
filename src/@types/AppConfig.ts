export interface AppConfig {
  ...
  evolvingNFT?: {
    /** Admin key for evolving NFT operations */
    adminKey?: string;
    /** Supply key for minting evolving NFTs */
    supplyKey?: string;
    /** Metadata key for evolving NFT metadata updates */
    metadataKey?: string;
    /** Default treasury account for evolving NFTs */
